...
def generate_launch_description():
    ...
    isaac_moveit_share = get_package_share_directory("retail_bin_picking_manipulation")
    ...
    rviz_config_file = os.path.join(
        get_package_share_directory("retail_bin_picking_manipulation"),
        "rviz",
    ...
    gripper_to_isaac_bridge = Node(
        package="retail_bin_picking_manipulation",
